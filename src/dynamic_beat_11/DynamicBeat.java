...
public class DynamicBeat extends JFrame {
    ...
    public DynamicBeat(){
        ...
        trackList.add(new Track("Mighty Love Title Image.png","Mighty Love Start Image.png","Mighty Love Game Image.jpg","Mighty Love Selected.mp3","Joakim Karud - Mighty Love.mp3","Joakim Karud - Mighty Love"));
        trackList.add(new Track("Wild Flower Title Image.png","Wild Flower Start Image.png","Wild Flower Game Image.jpg","Wild Flower Selected.mp3","Joakim Karud - Wild Flower.mp3","Joakim Karud - Wild Flower"));
        trackList.add(new Track("Energy Title Image.png","Energy Start Image.png","Energy Game Image.jpg","Energy Selected.mp3","Bensound - Energy.mp3","Bensound - Energy"));
        trackList.add(new Track("Paint the town red Title Image.png","Paint the town red START image.jpg","Paint the town red GAME image.png","Paint the town red Select music.mp3","Paint the town red Start Music.mp3","Doja cat - Paint The Town Red"));
    ...
    public void gameStart(int nowSelected, String difficult){
        ...
        isGameScreen=true;
        game = new Game(trackList.get(nowSelected).getTitleName(),difficult, trackList.get(nowSelected).getGameMusic());
        game.start();
        setFocusable(true);
        requestFocus();
    }
